...
export const loginPasante = async (req, res) => {
  const { email, password } = req.body;

  try {
    const usuario = await Usuario.findOne({ email, rol: 'Pasante' });
...
export const cambiarPasswordPasante = async (req, res) => {
  ...
  try {
    ...
    const usuarioEncontrado = await Usuario.findOne({ email, rol: 'Pasante' });
